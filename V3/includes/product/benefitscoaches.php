		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 column">
				...
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
					...
					<p>Access athlete information from anywhere through a cloud drive. Track multiple variables including performance metrics, scores, objectives, and rankings. Gain athlete performance insight across training, practice, and game situations.</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 column">
				...
				<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
					...
					<p>Collect quantitative data to help improve training and practice strategies. Use athlete analytics to improve decision-making abilities for game-day lineups. Save time and resources by collecting data instantly.</p>
				</div>
			</div>
		</div>
